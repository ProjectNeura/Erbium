...
def __entry__() -> None:
    ...
    compose_create.add_argument("input_dir")
    compose_create.add_argument("output_dir")
    compose_create.add_argument("save_as")
    compose_up = compose_sub.add_parser("up")
    compose_up.add_argument("profile_path")
    compose_up.add_argument("service_name")
